...
Uses keypoints model (DenseNet169) as primary when landmarks detected
Falls back to final model (DenseNet201) on cropped hand image

Compatible with existing index.html template
